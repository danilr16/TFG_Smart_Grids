...
for dia in range(dias):
    ...
    for min in range(3, minutos, 5):
        ...
        with open(directorio+'day_'+str(dia+1)+'/RESULT_OPF_min'+str(min).zfill(4)+'.put', 'r') as archivo:
        ...
        matriz.append(fila)
        # Añado Qgen7
        fila_gen = lineas[1].split(' ')
        matriz.append(fila_gen)
...
#        matriz_V = matriz_V.reshape(1, len(matriz_V))
        dato_minuto = pd.DataFrame(matriz_V,
                                   columns=['V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7', 'V8', 'V9', 'V10', 'V11', 'V12',
                                            'V13', 'V14','I0_1','I0_12','I1_2','I2_3','I3_4','I4_5','I5_6','I7_8','I8_3','I8_9','I9_10','I10_11','I12_13', 'PERD','QGEN7'], index=['day'+str(dia+1)+'_min'+str(min).zfill(4)])
...
out_data.to_csv(rutasalida + 'opf_out.txt')
