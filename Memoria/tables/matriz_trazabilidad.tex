\begin{table}[htp]
	...
	\begin{tabular}{|m{5.5cm}|c|c|c|c|c|}
		...
		\textcolor{white}{\textbf{Requisito \textbackslash\ Objetivo}} & \textcolor{white}{\textbf{OBJ-1}} & \textcolor{white}{\textbf{OBJ-2}} & \textcolor{white}{\textbf{OBJ-3}} & \textcolor{white}{\textbf{OBJ-4}} & \textcolor{white}{\textbf{OBJ-5}} \\
		\hline
		\textbf{RG-01:} Creación del \textit{Pipeline} de Aprendizaje Automático & & X & X & X & X \\
		\hline
		...
		\hline
		\textbf{RF-09:} Visualización de Resultados & & & & & X \\
		\hline
