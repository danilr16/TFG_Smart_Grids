\begin{table}[htp]
	...
	\renewcommand{\arraystretch}{1.3}
		\begin{tabular}{ | m{7cm} | m{8cm} | }
			...
			\textcolor{white}{\textbf{Requisito Funcional}} & \textcolor{white}{\textbf{Descripción}}\\
			\hline
			...
			\hline 
			RF-04: Implementación de Redes Neuronales Multipropósito & El sistema debe ser capaz de construir arquitecturas de aprendizaje automático con múltiples salidas independientes, permitiendo predecir simultáneamente variables con naturalezas distintas \\
			\hline
			...
			\hline
			RF-09: Visualización de Resultados & El sistema debe generar las gráficas pertinentes para la contrastación de los resultados obtenidos por los modelos con el conjunto de validación final \\
			\hline
