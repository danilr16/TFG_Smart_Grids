...
\setTitle{Smart Set Points: control de redes eléctricas con Inteligencia Artificial}
...
\begin{document}
    ...
    \input{sections/04_Planificación}
    \input{sections/05_Análisis}
    \input{sections/06_Implementación}
